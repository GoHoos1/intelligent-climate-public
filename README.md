...
- **0.0.23**
  ...
  - Keeps the result suppressed and zero-command while clearing the current
    generic safety-evaluation fault.
- **0.0.22**
...
- **0.0.20**
  ...
  - Adds an exact-minimum-version import gate to the release CI workflow.
- **0.0.19**
...
- **0.0.18**
  ...
  - Adds clearer adaptive time ticks to Today and hides duplicate effective
    target lines until an override makes them different.
  - Adds privacy-bounded before-and-after details to Activity when they are
    known, without exposing entity or source identifiers.
- **0.0.17**
...
- **0.0.14**
  ...
  - Adds authoritative current/next-target and daylight-saving previews plus
    revision-conflict recovery and unsaved-change protection.
- **0.0.13**
...
- **0.0.12**
  ...
  - Reduces the Today chart height for tablet and mobile displays.
- **0.0.11**
